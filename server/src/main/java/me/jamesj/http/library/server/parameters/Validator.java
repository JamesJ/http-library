...
public interface Validator<T> {
    ...
    static Validator<String> regex(Pattern pattern) {
    ...
    class RegexValidator implements Validator<String> {
        ...
        @Override
        public @Nullable Failure test(@Nullable String s) {
            if (pattern.matcher(s).matches()) {
                return null;
            }
            return Failure.of("String \"" + s + "\" does not match regex \"" + pattern.pattern() + "\"");
        }
    }
