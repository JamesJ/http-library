package me.jamesj.http.library.parameters.v2;
...
public interface Source {
    ...
    abstract class AbstractSource implements Source {
        ...
        protected AbstractSource(@NotNull String name) {
            this.name = name;
        }
     ...
     *
     * @see me.jamesj.http.library.parameters.parser.Parser
     * @see me.jamesj.http.library.parameters.files.File
     */
    class Result {
